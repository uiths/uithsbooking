            ...
            <div>
                <main>
                    <div id="home" className="carousel slide carousel-fade" data-ride="carousel">
                        ...
                        <form autoComplete="off" className="home_search" onSubmit={e => { e.preventDefault();}} method="get">
                            <i className="fa fa-search"/>
                            <input onChange={(e) => this.setState({key:handleString(e.target.value)})} type="search" name="search" placeholder="Tìm kiếm" required=""/>
                            <Link className="btn btn-success" to={`/search?key=${this.state.key}`}>Tìm kiếm</Link>
                        </form>
                    </div>
                    <RentalList/>
